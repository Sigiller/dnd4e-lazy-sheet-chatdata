...
| 2026-04-17 | модуль 0.5.0: `lazySheetListFastMetrics` в JSON collect при включённом `logSheetListFastAggregates` + глобальный снимок после prep | 5d819ae | 464ee16 | — | — | — | — | Пример без настройки: `sheet-perf-collect-1776432867983.json` (`lazySheetListFastSettingOn: false`). После включения настройки в мире — `lazySheetListFastMetrics` с callCount/totalMs/avgMs. |
