/**
 * Эквивалент хвоста Item4e.getChatData без enrichHTML по описанию.
 * Апстрим: отдельный метод Item4e.getChatDataForSheetList() или опция { sheetList: true }.
 *
 * @this {Item}
 */
import { MODULE_ID } from "../constants.js";
import { recordSheetListFastMs } from "./sheet-list-fast-metrics.js";
...
export async function getChatDataSheetListFast(htmlOptions = {}, variance = {}) {
	...
	if (game.settings?.get(MODULE_ID, "logSheetListFastAggregates")) {
		recordSheetListFastMs(performance.now() - t0);
	}
	return data;
}
