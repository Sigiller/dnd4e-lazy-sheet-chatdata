/**
 * LRU для результата enrichHTML (без собственной регистрации libWrapper).
 * Вызывается из prep-skip-enrich-html.js одним обёртыванием.
 * Апстрим: общий кэш в TextEditor или на уровне системы.
 */
...
/**
 * @param {function} wrapped — следующий enrichHTML в цепочке libWrapper (обычно оригинал)
