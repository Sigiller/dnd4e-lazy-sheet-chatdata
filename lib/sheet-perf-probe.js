...
import { getActorSheet4eMethodTargets } from "./libwrapper-register.js";
const LOG_CAP = 200;
...
/**
 * Try libWrapper on known ApplicationV2 / Handlebars sheet render internals (v14).
 */
export function registerSheetPerfLibWrapperProbes() {
	const ASV2 = foundry.applications.sheets?.ActorSheetV2;
	const ActorSheet4e = globalThis.dnd4e?.applications?.sheets?.ActorSheet4e;
	const candidates = [];
	if (ActorSheet4e) candidates.push(...getActorSheet4eMethodTargets(ActorSheet4e, "_renderHTML"));
	candidates.push(
